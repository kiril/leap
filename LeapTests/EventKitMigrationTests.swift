...
class EventKitMigrationTests: XCTestCase {
    ...
    func testRecurrence() {
        ...
        let r3: Leap.Recurrence = ek3.asRecurrence()

        XCTAssertEqual(r3.count, 0)
        XCTAssertEqual(r3.interval, 2)
        XCTAssertEqual(r3.frequency, Leap.Frequency.yearly)
        XCTAssertEqual(r3.daysOfWeek.count, 1)
        XCTAssertEqual(r3.daysOfWeek[0].dayOfWeek, Leap.DayOfWeek.tuesday)
        ...
        let r4: Leap.Recurrence = ek4.asRecurrence()

        XCTAssertEqual(r4.count, 0)
        XCTAssertEqual(r4.interval, 1)
        XCTAssertEqual(r4.frequency, Leap.Frequency.weekly)
        XCTAssertEqual(r4.daysOfWeek.count, 2)
        XCTAssertEqual(r4.daysOfWeek[0].dayOfWeek, Leap.DayOfWeek.tuesday)
        XCTAssertEqual(r4.daysOfWeek[1].dayOfWeek, Leap.DayOfWeek.thursday)
