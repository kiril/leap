...
class ScheduleEntryWrapper: IGListDiffable {
    ...
    func isEqual(toDiffableObject object: IGListDiffable?) -> Bool {
        ...
        case let (.event(a), .event(b)):
            return (a == b) && (a.userResponse.value == b.userResponse.value) && (a.temporarilyForceDisplayResponseOptions == b.temporarilyForceDisplayResponseOptions) // this is horrible, but that transient state of the temporary thing lets me make sure we re-render
